...
For the calendar you only have to include the `calendar.css` and `desktop.js` files.
If you want to localize your Calendar, it's enough to add this line before including desktop.js:
```html
