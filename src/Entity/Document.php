...
class Document
{
    ...
    {
        // create directory upload/course/{id_course}/document/ if it doesn't already exist
        FileUploader::createDir($this->getCourse()->getDir() . "/", "document");

        return $this->getCourse()->getDir() . "/document";
    }
